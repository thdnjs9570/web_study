package com.gura.spring03.file.view;
 ...
 * 
 *  - AbstractView 추상클래스를 상속받아서 만든다
 *  - @Component를 붙이고 컴포넌트 스캔이 일어나게 한다.
 *  - @Component("view의 이름") view의 이름을 지정한다.
 *  - servlet-context.xml 에 BeanNameViewResolver 설정하기
 * 
 */

//@Component("bean(뷰)의 이름")
@Component("fileDownView")//클래스의 첫글자를 소문자로 만들어서 bean의 이름을 만든다.
public class FileDownView extends AbstractView{
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		//여기서 얼마든지 응답 가능 
		//여기로 forward 이동시켜서(이쪽으로 forward 이동할때는 markup으로 보는게 아니라 그냥 다운로드만 하고싶을때)
